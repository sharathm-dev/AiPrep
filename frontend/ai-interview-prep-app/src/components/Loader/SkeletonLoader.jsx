    ...
    return (
        <>
            <div role="status" className="animate-pulse space-y-4 max-w-3xl">
                ...
                <div className="h-10 bg-gray-100 dark:bg-gray-700 rounded p-4 space-y-2">
                    <div className="h-2.5 dark:bg-gray-300 w-3/4"></div>
                    <div className="h-2.5 dark:bg-gray-300 w-1/2"></div>
                    <div className="h-2.5 dark:bg-gray-300 w-1/2"></div>
                </div>
            </div>
